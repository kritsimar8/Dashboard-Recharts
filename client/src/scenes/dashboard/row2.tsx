  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis yAxisId="left" tickLine={false} orientation="left" axisLine={false} style={{fontSize:"10px"}} />
      ...
      <Box ml="-0.7rem" flexBasis= "40%" textAlign="center">
          ...
          <Typography m="0.3rem 0" variant="h3" color={palette.primary[300]}>
            ...
            <Typography variant="h6">Finance goals of the campaigns that is desired</Typography>
      </Box>
      <Box flexBasis="40%">
